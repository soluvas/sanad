...
/**
 * A representation of the model object '<em><b>SuccessivityClaim</b></em>'.
 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Claims
 * that specified Concept has the specified successivity. <!-- end-model-doc -->
 * 
 * @generated
 */
@Entity()
public class SuccessivityClaim extends Claim {
	...
	/**
	 * Sets the '{@link SuccessivityClaim#getSuccessivity()
	 ...
	 *            {@link SuccessivityClaim#getSuccessivity() successivity}'
	 *            feature.
	 * @generated
	 */
	...
	public String toString() {
		return "SuccessivityClaim " + " [successivity: " + getSuccessivity()
				+ "]";
	}
}
